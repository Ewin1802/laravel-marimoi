...
<div class="form-group">
    ...
    <div class="input-group">
        ...
        <input type="text" id="code" name="code" value="{{ old('code', $member->code ?? '') }}"
            class="form-control @error('code') is-invalid @enderror" placeholder="Contoh: MRM-AB12CD34">
...
@isset($member)
    <div class="form-group">
        ...
        <input type="number" min="0" name="stamp_count" value="{{ old('stamp_count', $member->stamp_count) }}"
...
<div class="form-group">
    ...
    <input type="number" min="1" name="stamp_target"
